...
//	private $data = array(
//		'module_name' => '选手报名',
//		'module_url'  => '/admin/propser/',
//		'module_slug' => 'propsers',
...
//	);
    ...
    public function create()
    {
        ...
        $this->data['edit_fields'] = array(
            'nick_name' => array('type' => 'text', 'label' => '申请人昵称'),
            'real_name' => array('type' => 'text', 'label' => '申请人真名'),
            'id_card_num' => array('type' => 'text', 'label' => '身份证号'),
            'phone' => array('type' => 'text', 'label' => '电话号码'),
            'bank_num' => array('type' => 'text', 'label' => '银行卡卡号'),
            'bank' => array('type' => 'text', 'label' => '所属银行'),
            'status' => array('type' => 'text', 'label' => '当前状态'),
            'sign_time' => array('type' => 'text', 'label' => '报名时间','class'=>'datepicker','extra'=>array('data'=>array('format'=>'YYYY-MM-DD hh:mm:ss'),'wrapper'=>'col-sm-3')),
            'audit_time' => array('type' => 'text', 'label' => '审核时间','class'=>'datepicker','extra'=>array('data'=>array('format'=>'YYYY-MM-DD hh:mm:ss'),'wrapper'=>'col-sm-3')),
        );
